...
description:
  ErrorBoundary, error responses, isRouteErrorResponse, error reporting
tags: [errors, ErrorBoundary, useRouteError, isRouteErrorResponse, 404, 500]
---

# Error Handling

React Router catches errors in loaders, actions, and rendering, then displays
them in error boundaries.
...
In production, error messages are sanitized to prevent leaking sensitive info.
Full error details are only shown in development.
