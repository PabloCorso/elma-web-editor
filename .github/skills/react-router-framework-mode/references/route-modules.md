...
title: Route Modules
description:
  All route module exports - loader, action, meta, links, ErrorBoundary, etc.
tags:
...
Route modules are files referenced in `routes.ts` that define automatic
code-splitting, data loading, actions, revalidation, error boundaries, and more.
For routing configuration, see [routing.md](./routing.md).
